...
# **Топология**
![There are 2 routers, 2 switches, and 2 PCs in this topology. Router R2 has a loopback interface. Router R2 g0/0/0 is connected to R1 G0/0/0. Router R1 G0/0/1 is connected to S1 F0/5.  S1 F0/1 is connected S2 F0/1. S1 F0/6 is connected to PC-A. S2 F0/18 is connected to PC-B.](001.png)
# **Таблица адресации**
...
Загружены базовые настройки маршрутизаторов

1. ### **Настройте базовые параметры каждого коммутатора.**
Загружены базовые параметры каждого коммутатора
...
```
      ...
      icmp 209.165.200.226:4 192.168.1.3:4 209.165.200.225:4 209.165.200.225:4
```
Вопросы:
