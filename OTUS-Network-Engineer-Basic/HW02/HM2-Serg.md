...
# **Топология**
![There are two switches and two PCs in the topology. PC-A is connected to S1 via F0/6. S1 F0/1 is connected to S2 F0/1. PC-B is connected to S2 via F/18.](Aspose.Words.a5974593-66a1-4061-b8f1-20f2e6e6fc2d.001.png)
# **Таблица адресации**
