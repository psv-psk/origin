...
# **Топология**
![This topology has 2 routers and 2 switches. Router R1 has loopback 1 interface and R1 G0/0/1 is connected to S1 F0/5. Switch S1 F0/1 to Switch S2 F0/1. Switch S2 F0/5 is connected to R2 G0/0/1. R2 has loopback 1 interface.](001.png)
# **Таблица адресации**
