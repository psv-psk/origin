...
Для настройки маршрутизации с использованием протокола OSPF на коммутаторе и создания двух независимых маршрутов для каждого провайдера, чтобы обеспечить отказоустойчивость, используем следующие команды:
